...
import { saveFileToBucket, firestore } from "./firestorage.server";

export async function addBook(book, userId) {
  // save to firestore database without picture information
  ...
  // update doc on db with picture urls
